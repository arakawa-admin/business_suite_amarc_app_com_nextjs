...
// import { ApprovalCreateButton } from "@/components/approval/buttons/ApprovalCreateButtons";
...
import SwitchStaffButton from "@/components/ui/SwitchStaffButton";
import SwitchActiveSystemButton from "@/components/ui/SwitchActiveSystemButton";
...
export default function Header() {
    ...
    // 共通のメインボタンコンポーネント（アンマウントを防ぐため外部に定義）
    // const mainButtons = (
    //     <>
                ...
                >
                    ...
                    >
                        ...
                        <Stack spacing={1}>
                            ...
                            <SwitchActiveSystemButton mobile />
                            <HelpButton mobile />
                            <AdminButton mobile />
                            <LogoutButton mobile />
                        </Stack>
