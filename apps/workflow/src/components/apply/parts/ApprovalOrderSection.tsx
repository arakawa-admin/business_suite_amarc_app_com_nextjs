...
import ApprovalOrderForm from "@/components/apply/forms/ApprovalOrderForm";
// import ApplicationReturnSection from "@/components/apply/parts/ApplicationReturnSection";

// import { ApprovalActionForOrderDeleteButton } from "@/components/apply/buttons/ApprovalActionDeleteButton";
...
// import { ApprovalActionType } from "@/schemas/apply/approvalActionSchema";

export default function ApprovalOrderSection({
    application,
}: {
    ...
    return (
        <Box>
            ...
            <Paper
                ...
                >
                <Stack spacing={2}>
                    {application.approval_orders && application.approval_orders.sort((a, b) => a.sequence - b.sequence).map((o, i) => (
                        <Paper
                            key={i}
                            elevation={8}
                            >
                            ...
                            <Stack spacing={1}>
                                ...
                                {/* 差し戻し中だけ */}
                                {/* <ApplicationReturnSection approval={approval} approvalOrder={o} /> */}
                            </Stack>
                        </Paper>
                    ))}
                </Stack>
