...
import { deleteVehicleCommentAction } from "@/app/(protected)/vehicles/[id]/comments/actions";
import { useAuth } from "@contexts/AuthContext";
import { type CommentListItem } from "@/features/vehicles/comments/repositories/commentRepository";

export function VehicleCommentDeleteButton({
    comment,
    vehicleId,
}: {
    ...
    const handleDelete = () => {
        ...
        startTransition(async () => {
            const result = await deleteVehicleCommentAction({
