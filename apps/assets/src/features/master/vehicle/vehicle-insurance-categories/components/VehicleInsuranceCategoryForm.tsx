...
import type { VehicleInsuranceCategoryActionState } from "../types/vehicleInsuranceCategoryTypes";
...
type Props = {
    defaultValues: VehicleInsuranceCategoryActionState;
    action: (
...
export function VehicleInsuranceCategoryForm({
    defaultValues,
    action,
    submitLabel = "登録",
}: Props) {
