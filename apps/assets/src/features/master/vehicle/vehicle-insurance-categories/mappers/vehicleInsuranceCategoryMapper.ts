...
export function toVehicleInsuranceCategoryModel(
...
export function toVehicleInsuranceCategoryInsertInput(
...
export const vehicleInsuranceCategoryMapper = {
    toModel: toVehicleInsuranceCategoryModel,
    toInsertInput: toVehicleInsuranceCategoryInsertInput,
};
