...
export function toVehicleInsuranceAgencyModel(
    row: VehicleInsuranceAgencyRawRow,
): VehicleInsuranceAgency {
    return {
        id: String(row.id ?? ""),
...
export function toVehicleInsuranceAgencyInsertInput(
...
export function toVehicleInsuranceAgencyUpdateInput(
    input: VehicleInsuranceAgencyFormValues,
    currentStaffId: string,
): Record<string, unknown> {
    return {
