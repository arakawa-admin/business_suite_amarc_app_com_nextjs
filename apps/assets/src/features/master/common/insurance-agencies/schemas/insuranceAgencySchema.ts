...
export type InsuranceAgencySchemaInput = z.input<
    typeof insuranceAgencySchema
>;

export function toInsuranceAgencyFormValues(
    input: InsuranceAgencySchemaInput,
): InsuranceAgencyFormValues {
    const parsed = insuranceAgencySchema.parse(input);
