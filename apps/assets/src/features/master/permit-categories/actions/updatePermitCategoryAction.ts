...
export async function updatePermitCategoryAction(
    ...
    revalidatePath("/admin/permit-categories");
    revalidatePath(`/admin/permit-categories/${id}`);
    revalidatePath(`/admin/permit-categories/${id}/edit`);

    redirect(`/admin/permit-categories/${id}`);
}
