...
import { SELECTED_STAFF_COOKIE_KEY } from "@/features/auth/constants/authConstants";
...
export default function SelectStaffPage() {
    ...
    const returnTo = sp.get("returnTo")
        ? decodeURIComponent(sp.get("returnTo")!)
        : null;
    ...
    const handleSelect = (staffId: string) => {
        start(async () => {
            ...
            document.cookie = `${SELECTED_STAFF_COOKIE_KEY}=${encodeURIComponent(
                staff.id,
            )}; path=/; samesite=lax`;
